...
@DisplayName("Student Update Mail - Name change")
public class StudentUpdateMailTest {
...
@DisplayName("Student Update Mail - Name Change Test")
@Test
@Order(1)
public void updtMailA() {
 ...
 assertEquals("a", vars.get("x").toString());
}



@DisplayName("Student Update Mail - Delete Left")
@Test
@Order(2)
public void updtMailB() {
	driver.get("http://localhost:4200/");
    driver.manage().window().setSize(new Dimension(1062, 812));
